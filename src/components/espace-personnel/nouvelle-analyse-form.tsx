...
import { Briefcase, FileText, Clock, Calendar, Activity, Save } from "lucide-react"
...
export default function NouvelleAnalyseForm() {
  ...
  const handleScoreChange = (scoreType: 'debit' | 'absorption' | 'recuperation' | 'environnement', value: number[]) => {
    setFormData(prev => ({
      ...prev,
      scores: {
        ...prev.scores,
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <Input 
                id="tache" 
                placeholder="Ex: Montage de composants"
          ...
          <div className="pt-4 border-t border-slate-700/50">
            <h3 className="text-lg font-medium text-white mb-4">Paramètres d'analyse</h3>
